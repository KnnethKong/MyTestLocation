...
public class PermissionTools {
     ...
     */
    public PermissionTools(Object object) {
        mObject = object;
        isHasCheck = false;
    }
    ...
    private void initMap() {
        if (null == mAllPermissonMap) {
            ...
            mAllPermissonMap.put(Manifest.permission_group.LOCATION, "permission_group.LOCATION");
        }
    }
    ...
    public boolean lacksPermissions(String... permissions) {
        ...
        for (String permission : permissions) {
            boolean isTrue = lacksPermission(permission);
            Log.i("kxflog", permission.toString() + "---" + isTrue);
